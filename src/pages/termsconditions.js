  ...
  render() {
    return (
      <div>
        ...
        <div style={{ padding: '30px', textAlign: 'left', maxWidth: '1200px' }}>
          <h1 className="text-4xl font-extrabold text-black sm:text-center sm:text-6xl">
            Terms and Conditions
          </h1>
          <p>Last updated: 06/10/2022</p>
          <p>
            Please read these terms and conditions carefully before using Our
            Service.
          </p>
          <p>
            This website isn&quot;t financial advise, always do your own
            research, we cannot be held responsible for any kind of loss.
          </p>
          <h1 className="text-2xl font-extrabold text-black sm:text-center sm:text-4xl">
          ...
          <strong>
            Every created account receives 3 free credits. It is prohibited for
            a single user to create multiple accounts in order to abuse these
            free credits. We reserve the right to ban any abusing user out of
          ...
          <strong>
            Your account will be recredited every month if you have subscribed
            to a monthly package or every year if you have subscribed to a
            yearly package.
          </strong>
          <strong>
            Credits are automatically delivered when the payment is received via
            Stripe.
          </strong>
          <strong>
          ...
          <br />
          <h1 className="text-4xl font-extrabold text-black sm:text-center sm:text-6xl">
            License of the generated images
          </h1>
          <br />
          <strong>
            ...
            <br />
            Images coming from Pixabay are under Pixabay License available on
